        ...
        <nav className="navbar px-4 py-4 mt-4" >
            <div className="container-fluid d-flex justify-content-spacebetween align-items-center" >
                ...
                <div className="input-group">
                    <input type="text" defaultValue={search} onChange={(e) => setsearch(e.target.value)} onKeyDown={(e) => { enterSearch(e) }} className="form-control bg-transparent ps-md-4" placeholder="Pesquise um filme aqui..." aria-label="Username" aria-describedby="basic-addon1" />
